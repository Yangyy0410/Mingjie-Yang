...
h1 = Bidirectional(GRU(64, return_sequences=True))(inputdata)
h2 = Bidirectional(GRU(64, return_sequences=True))(h1)
h3 = Bidirectional(GRU(64, return_sequences=True))(h2)
h4 = Bidirectional(GRU(64))(h3)
...
model.load_weights('ep087-val_loss0.136.h5')
