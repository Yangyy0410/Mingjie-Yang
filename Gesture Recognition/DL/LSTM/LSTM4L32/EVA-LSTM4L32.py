...
h1 = Bidirectional(LSTM(32, return_sequences=True))(inputdata)
h2 = Bidirectional(LSTM(32, return_sequences=True))(h1)
h3 = Bidirectional(LSTM(32, return_sequences=True))(h2)
h4 = Bidirectional(LSTM(32))(h3)
...
model.load_weights('ep166-val_loss0.112.h5')
