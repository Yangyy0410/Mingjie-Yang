...
h1 = Bidirectional(SimpleRNN(64, return_sequences=True))(inputdata)
h2 = Bidirectional(SimpleRNN(64, return_sequences=True))(h1)
h3 = Bidirectional(SimpleRNN(64))(h2)
outputs = Dense(4, activation='softmax')(h3)
...
model.load_weights('ep045-val_loss1.012.h5')
