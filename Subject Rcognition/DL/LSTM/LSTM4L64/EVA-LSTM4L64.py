...
h1 = Bidirectional(LSTM(64, return_sequences=True))(inputdata)
h2 = Bidirectional(LSTM(64, return_sequences=True))(h1)
h3 = Bidirectional(LSTM(64, return_sequences=True))(h2)
h4 = Bidirectional(LSTM(64))(h3)
...
model.load_weights('ep143-val_loss0.533.h5')
